...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Lambo.</a>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#">Aventador</a></li>
            <li><a class="dropdown-item" href="#">Urus</a></li>
    ...
    <div class="col-md-4">
        <div class="card rounded">
            <div class="card-image">
                ...
                <img class="img-fluid" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSl8agZCrz2o3WDbPDFYIZke9UsTHVNaNvmNH6UjGXSjnSz9zvHHrf7L4P9nVdQRCTYqlo&usqp=CAU" alt="Alternate Text" />
            </div>
            <div class="card-image-overlay m-auto">
                <span class="card-detail-badge">Used</span>
                <span class="card-detail-badge">$28,000.00</span>
    ...
    <div class="col-md-4">
        <div class="card rounded">
            <div class="card-image">
                ...
                <span class="card-notify-year">2018</span>
                <img class="img-fluid" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRrDGfsbJ7vd1yRo6oHIUp-hX8jUaHVqgevUw&s" alt="Alternate Text" />
            </div>
            <div class="card-image-overlay m-auto">
                <span class="card-detail-badge">Used</span>
